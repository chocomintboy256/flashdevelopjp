===============================================================================
	FlashDevelop用 Progression 4.0.22 プロジェクトテンプレート
...
■インストール方法
	...
	・Templates
	の3つのフォルダを移動（上書き）します。
	※Progression 4.0.1 以前から 4.0.22 にバージョンアップする際は、フォルダ構成が一部変わっているため、後述のアンインストール方法でアンインストールを行ってから上書きしてください。
...
■リリースノート
	2010/09/03 更新 dkgkAs
		Progression 4.0.22 リリースに伴う更新。
